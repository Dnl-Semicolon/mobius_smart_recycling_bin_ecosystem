...
class DetectionPipelineService
{
    ...
    {
        // 1. Detect waste type via Roboflow
        ...
        // 2. If it's a cup, detect brand via OpenAI
        $brandSlug = null;
        $brandId = null;
        $openaiResponse = null;
    ...
    private function updateBinState(Bin $bin, string $wasteType): void
    {
        ...
        $capacityGrams = $bin->capacity_liters * 50; // rough: 50g per liter of cup waste
