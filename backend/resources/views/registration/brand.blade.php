<x-layouts.app title="Register as Brand Partner">
    <div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 via-white to-emerald-50/30 px-4 py-12">
        <div class="w-full max-w-lg">
            ...
            <div class="text-center mb-8">
                ...
                <h1 class="text-2xl font-bold text-gray-900 tracking-tight">Register as Brand Partner</h1>
                <p class="text-sm text-gray-500 mt-1.5">Join the Mobius recycling ecosystem</p>
            </div>
            ...
            <form method="POST" action="{{ route('registration.brand.store') }}" class="space-y-5">
                @csrf
                ...
                <div>
                    ...
                    <textarea
                        ...
                        name="description"
                        rows="4"
                        placeholder="Tell us about your company and why you want to partner with Mobius"
                        required
