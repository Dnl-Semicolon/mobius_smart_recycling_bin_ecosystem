    ...
    <div class="min-h-screen flex items-center justify-center bg-gray-50 px-4 py-12">
        <div class="w-full max-w-lg">
            <div class="text-center mb-8">
                ...
                <h1 class="text-xl font-semibold text-gray-900">Brand Registration</h1>
                <p class="text-sm text-gray-500 mt-1">Register your brand to partner with the platform</p>
            </div>

            <x-card class="p-6">
                <form method="POST" action="{{ route('registration.brand.store') }}" enctype="multipart/form-data" class="space-y-5">
                    @csrf
                    ...
                    <fieldset class="space-y-4">
                        ...
                        <x-input
                            ...
                            placeholder="e.g. Starbucks Malaysia"
                            required
                            autofocus
                        />
