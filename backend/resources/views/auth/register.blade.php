        ...
        <div class="w-full max-w-md relative z-10">
            ...
            <x-card class="p-6 hero-animate hero-animate-delay-1">
                ...
                <p class="text-center text-sm text-gray-500 mt-4">
                    ...
                    <a href="{{ route('login') }}" class="text-emerald-600 hover:text-emerald-700 font-medium underline decoration-emerald-300 underline-offset-2 hover:decoration-emerald-500">Sign in</a>
                </p>
            </x-card>
        </div>
    </div>
